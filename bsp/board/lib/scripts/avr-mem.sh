...
# Written by Jцrg Wunsch and Eric B. Weddington
...
"atmega1280")  PROGMAX=${AVR128K}; DATAMAX=${AVR8K}; EEPROMMAX=${AVR4K};XDATAMAX=${AVR54K};;
...
${AVRSIZE} -A "$1" | ${AWK} -v progmax=${PROGMAX} \
							-v datamax=${DATAMAX} \
							-v eeprommax=${EEPROMMAX} \
							-v xbssmax=${XDATAMAX} \
							-v device=$2 -- '
