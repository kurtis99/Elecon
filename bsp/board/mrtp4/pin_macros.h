...
/* Светодиодная мигание светодиодом */
    #define LED_BLINK1 C,4,H
    #define LED_BLINK2 C,5,H
    #define LED_BLINK3 C,6,H
    #define LED_BLINK4 C,7,H

/* Переключался направляения передачи данных в УСАПП */
    #define SET_USART0_TX C,PC0,L
    #define SET_USART1_TX C,PC2,L
    #define SET_USART1_RX C,PC3,H
